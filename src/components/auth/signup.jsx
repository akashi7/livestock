          ...
          <Form className='space-y-12' action='#'>
            ...
            <div className='flex items-center justify-center'>
              {!loader && (
                <button
                  type='submit'
                  className='w-[50%] h-[50px] bg-blue text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
                >
                  SIGN UP
                </button>
              )}
